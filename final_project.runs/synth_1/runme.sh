...
HD_PWD='C:/Users/eliu/final_project/final_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log negate.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source negate.tcl
